...
Asena.addCommand({pattern: 'cuzier ?(.*)', fromMe: true, desc: DDO, deleteCommand: true}, (async (message, match) => {    
...
Asena.addCommand({pattern: 'cuzierX ?(.*)', fromMe: true, desc: DDO, deleteCommand: true}, (async (message, match) => {    
