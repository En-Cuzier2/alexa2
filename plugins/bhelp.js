...
const Lang = Language.getString('anime');
    ...
    Asena.addCommand({pattern: 'help', fromMe: true, desc: 'show the besic help'}, (async (message, match) => {
