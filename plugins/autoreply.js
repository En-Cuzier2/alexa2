...
Asena.addCommand({pattern: 'queen', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

    var r_text = new Array ();    
r_text[0] = "කොහොමද ඔයාට?*";
r_text[1] = "*කෑවද මැනික*";
r_text[2] = "*මොකද කරන්නෙ අලෙ 😘*";
r_text[3] = "```type  .alexa for the command list```";
r_text[4] = "hi, how are you";
r_text[5] = "කම්මැලියි නේද?";
r_text[6] = "queen alexa ( type .alive)";
...
r_text[11] = "do you know who is my creator..? its none other than vishnukyk";
...
r_text[13] = ".song adich thangalude fav song name para meenutty ath download aakki theraam👩🏻";
...
r_text[18] = "enikk njan und meenu uyir💁🏻‍♀️";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe meenakshi pazhaya meenakshi thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik meenuttikk";
